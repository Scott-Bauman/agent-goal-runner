...
export class RunController {
  ...
  private createAutoCommitMessageArgs(
    ...
    if (phase === "review") {
      return [
        "-m",
        `agent-goal-runner: apply review after ${runLabel} ${runNumber} of ${totalRuns}`,
        "-m",
    ...
    return [
      "-m",
      `agent-goal-runner: apply ${runLabel} ${runNumber} of ${totalRuns}`,
      "-m",
      `Generated by agent-goal-runner after ${getAgentProviderLabel(provider)} and optional verification succeeded.`,
    ];
  }
